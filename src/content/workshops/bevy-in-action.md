...
Bevy has a few system dependencies and limitations, and attendees would benefit to do the [Getting Started](https://bevy.org/learn/quick-start/getting-started/) guide, in particular the [Setup](https://bevy.org/learn/quick-start/getting-started/setup/) to ensure their computer will be able to run the workshop.
